    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body" >
                    ...
                    <a href="manage_categories.php" class="btn btn-primary"><i class="fas fa-edit">&nbsp;</i>Manage</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body" >
                    ...
                    <a href="manage_brand.php" class="btn btn-primary"><i class="fas fa-edit">&nbsp;</i>Manage</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="manage_products.php" class="btn btn-primary"><i class="fas fa-edit">&nbsp;</i>Manage</a>
            </div>
        </div>
    </div>
